...
fun CharacterItem(character: Character, navigateToDetail: (Long) -> Unit){
    Row(horizontalArrangement = Arrangement.Center, modifier = Modifier
        ...
        Image(painter = painterResource(R.drawable.character_icon), contentDescription = "", modifier = Modifier.width(100.dp).height(100.dp))
        Column{
            ...
            Text(text = character.shortDesc, color = MaterialTheme.colorScheme.onBackground, fontSize = 20.sp)
        }
    }
}
